...
const translations: Record<string, Record<Lang, string>> = {
    ...
    'sp.hero.stat1.num': { en: '/fifty_percent.png', ar: '/fifty_percent.png' },
    ...
    'sp.problem.flow.1': { en: 'Ad', ar: 'إعلان' },
    'sp.problem.flow.2': { en: 'DM', ar: 'DM' },
    'sp.problem.flow.3': { en: 'Long conversation', ar: 'هدرة طويلة' },
    'sp.problem.flow.4': { en: 'Explanation + Objections', ar: 'شرح + اعتراضات' },
    'sp.problem.flow.5': { en: 'Maybe closes... maybe not ❌', ar: 'يمكن يتغلق... يمكن لا ❌' },
    ...
    'sp.hero.social_proof': { en: 'Join thousands of successful businesses and professionals worldwide', ar: 'انضم إلى آلاف الشركات والمهنيين الناجحين حول العالم' },
    ...
    'sp.benefits.b4.desc': { en: 'Same ad brings +50% income — without spending an extra dollar.', ar: 'نفس الإعلان يجيبلك +50% في الدخل — بلا ما تزيد دولار.' },
    ...
    'sp.proof.highlight.desc': { en: 'Approx. 50% increase in revenue — without spending an extra dollar on ads', ar: 'زيادة تقريبية 50% في الأرباح — بلا ما تزيد دولار واحد في الإعلانات' },
